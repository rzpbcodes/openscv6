...
if(_balances[msg.sender] >= value && value > 0) {
//_balances[msg.sender] = substractSafely(_balances[msg.sender, value]);
//_balances[to] = addSafely(_balances[ to], value);
